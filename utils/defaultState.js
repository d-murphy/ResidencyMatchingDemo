...
const applicants = [
 ...
 const programs = [
    {name: "Mercy", numPositions: 2, rank: ["Darrius", "Joseph"]},
    {name: "City", numPositions: 2, rank: ["Darrius", "Arthur", "Sunny", "Latha", "Joseph"]},
    {name: "General", numPositions: 2, rank: ["Darrius", "Arthur", "Joseph", "Latha"]}
 ];
